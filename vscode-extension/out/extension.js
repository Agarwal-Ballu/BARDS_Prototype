...
function activate(context) {
    const disposable = vscode.commands.registerCommand("hybrid.run", async () => {
...
`);
            ...
            // 5️⃣ Accuracy popup
            vscode.window.showInformationMessage(`✅ AI Accuracy Score: ${accuracy}%`);
        }
        catch (err) {
            vscode.window.showErrorMessage(`❌ Hybrid AI failed: ${err.message}`);
        }
    });
